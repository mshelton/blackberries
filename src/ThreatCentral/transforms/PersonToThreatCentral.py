...
@configure(
    label='Search Person in Threat Central',
    description='Searches Person in Threat Central',
    uuids=['threatcentral.v2.PersonToThreatCentral'],
    inputs=[('Threat Central', Person)],
    debug=False,
    remote=False
)
