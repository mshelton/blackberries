...
from common.client import search_case, get_case, encode_to_utf8, ThreatCentralError
...
@configure(
    label='Search Case in Threat Central',
    description='Searches Case in Threat Central',
    uuids=['threatcentral.v2.CaseToThreatCentral'],
