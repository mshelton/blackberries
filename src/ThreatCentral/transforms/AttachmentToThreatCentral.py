...
from common.entities import Attachments, Actor, Case, CoursesOfAction, Indicator, Incident, TTP
...
@configure(
    label='Search Attachment in Threat Central',
    description='Searches Attachment in Threat Central',
    uuids=['threatcentral.v2.AttachmentToThreatCentral'],
    inputs=[('Threat Central', Attachments)],
    debug=False,
    remote=False
)
