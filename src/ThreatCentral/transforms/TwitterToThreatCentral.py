...
from canari.maltego.entities import Twitter, Phrase
...
@configure(
    label='Search Twitter account in Threat Central',
    description='Searches Twitter account in Threat Central',
    uuids=['threatcentral.v2.TwitterToThreatCentral'],
    inputs=[('Threat Central', Twitter)],
    debug=False,
    remote=False
)
