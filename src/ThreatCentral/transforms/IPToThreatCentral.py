...
@configure(
    label='Search IP Address in Threat Central',
    description='Searches IP Address in Threat Central',
    uuids=['threatcentral.v2.IPToThreatCentral'],
    inputs=[('Threat Central', IPv4Address)],
    debug=False,
    remote=False
)
