...
from canari.maltego.entities import Alias, Phrase
...
@configure(
    label='Search Alias in Threat Central',
    description='Searches alias on Threat Central',
    uuids=['threatcentral.v2.AliasToThreatCentral'],
    inputs=[('Threat Central', Alias)],
    debug=False,
    remote=False
)
