...
from common.entities import Hyperlinks, Actor, Case, CoursesOfAction, Indicator, Incident, TTP
...
@configure(
    label='Search Hyperlink in Threat Central',
    description='Searches Hyperlink in Threat Central',
    uuids=['threatcentral.v2.HyperlinkToThreatCentral'],
    inputs=[('Threat Central', Hyperlinks)],
    debug=False,
    remote=False
)
