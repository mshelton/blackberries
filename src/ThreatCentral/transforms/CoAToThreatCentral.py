...
@configure(
    label='Search Course of Action in Threat Central',
    description='Searches Course of Action in Threat Central',
    uuids=['threatcentral.v2.CoAToThreatCentral'],
    inputs=[('Threat Central', CoursesOfAction)],
    debug=False,
    remote=False
)
